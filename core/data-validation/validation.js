...
const NO_API_SERVER = 'The server is temporarily unavailable.  Please try again later.';
...
try {
        module.exports = {
            ...
            NO_API_SERVER: 'The server is temporarily unavailable.  Please try again later.',
            ...
            BAD_USER_INFO: `The registration information supplied was invalid.  Passwords must be at least` +
                ` 10 characters long with one uppercase letter, one number and one special character.  ` +
